...
const CONTRACT_KEY_NAME: &str = "test_swappery_pair";

const TOKEN0_KEY_NAME: &str = "token0";
const TOKEN1_KEY_NAME: &str = "token1";
...
impl TestFixture {
    ...
    const TOKEN_TOTAL_SUPPLY_AS_U64: u64 = 1000000000;
    const CONTRACT_KEY_NAME_ARG_NAME: &str = "contract_key_name";
    const TOKEN0_CONTRACTPACKAGE_HASH: ContractPackageHash = ContractPackageHash::from([100u8; 32]);
    const TOKEN1_CONTRACTPACKAGE_HASH: ContractPackageHash = ContractPackageHash::from([101u8; 32]);
    ...
    pub fn install_contract() -> TestFixture {
        ...
        let session_args = runtime_args! {
            ...
            CONTRACT_KEY_NAME_ARG_NAME => CONTRACT_KEY_NAME,
            TOKEN0_KEY_NAME => TOKEN0_CONTRACTPACKAGE_HASH,
            TOKEN1_KEY_NAME => TOKEN1_CONTRACTPACKAGE_HASH
        };
