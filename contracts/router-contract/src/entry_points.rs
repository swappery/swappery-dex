...
use casper_types::{
    account::AccountHash, CLType, CLTyped, ContractHash, EntryPoint, EntryPointAccess,
...
pub fn create_pair() -> EntryPoint {
    EntryPoint::new(
        ...
        vec![
            ...
            Parameter::new(consts::PAIR_RUNTIME_ARG_NAME, Key::cl_type()),
        ],
        CLType::Unit,
